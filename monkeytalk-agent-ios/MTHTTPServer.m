#import "MTAsyncSocket.h"
#import "MTHTTPServer.h"
#import "MTHTTPConnection.h"


@implementation MTHTTPServer
...
- (id)init
{
	if(self = [super init])
	{
		...
		asyncSocket = [[MTAsyncSocket alloc] initWithDelegate:self];
		
		// Use default connection class of MTHTTPConnection
		connectionClass = [MTHTTPConnection self];
 ...
 * The default connection class is MTHTTPConnection.
 * If you use a different connection class, it is assumed that the class extends MTHTTPConnection
**/
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark MTAsyncSocket Delegate Methods:
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

-(void)onSocket:(MTAsyncSocket *)sock didAcceptNewSocket:(MTAsyncSocket *)newSocket
{
