...
+ (MTTimeouts*) timeoutsForSession:(MTSession*)session {
  return [[[MTTimeouts alloc] initWithSession:session] autorelease];
}
...
+ (MTImplicitWait*) implicitWaitForSession:(MTSession*)session {
  return [[[MTImplicitWait alloc] initWithSession:session] autorelease];
}
...
+ (MTScriptTimeout*) scriptTimeoutForSession:(MTSession*)session {
  return [[[MTScriptTimeout alloc] initWithSession:session] autorelease];
}
