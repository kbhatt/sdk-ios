...
- (NSObject<MTHTTPResponse> *)createSessionWithData:(id)desiredCapabilities
  ...
  MTSession* session = [[[MTSession alloc]
  ...
  return [MTHTTPRedirectResponse redirectToURL:
