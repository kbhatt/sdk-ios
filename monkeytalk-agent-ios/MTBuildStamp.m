...
+ (NSString*) buildStamp {
    return [NSString stringWithFormat:@"MonkeyTalk v%@%@%@ - %@ - Copyright 2012 Gorilla Logic, Inc. - www.gorillalogic.com", MT_VERSION, (MT_BUILD_NUMBER.length > 0 ? @"_" : @""), MT_BUILD_NUMBER, MT_BUILD_DATE];
}
