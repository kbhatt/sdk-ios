...
@property (nonatomic, readonly, retain) MTSession *session;
@property (nonatomic, readonly, retain) MTWebViewController *MTWebViewController;
...
@property (nonatomic, readonly, retain) MTElement* element;
