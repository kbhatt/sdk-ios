 ...
 * wire.
 */
@interface MTJSONRESTResource : NSObject<MTHTTPResource> {
 @private
  id target_;
  SEL action_;
}
...
@interface MTHTTPVirtualDirectory (JSONResource)
...
// the HTTP method called as an NSString. It returns a (NSObject<MTHTTPResponse>*)
