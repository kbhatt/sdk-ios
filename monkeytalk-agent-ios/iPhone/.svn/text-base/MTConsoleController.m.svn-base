...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    if (self = [super initWithNibName:nibNameOrNil bundle:nil]) {
		theMonkey = [[MonkeyTalk sharedMonkey] retain];
    }
...
- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath {
	if (!_editor) {
		...
		{
			_editor = [[[MTCommandEditViewController alloc] initWithNibName:@"MTCommandEditViewController_iPhone" bundle:nil] retain];
		}
		else
		{
			_editor = [[[MTCommandEditViewController alloc] initWithNibName:@"MTCommandEditViewController_iPad" bundle:nil] retain];
		}
